...
@SuppressLint("NewApi")
public class MainActivityChat extends ListActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(extra!=null){
			String email = extra.getString(DataProvider.COL_EMAIL);
			if(email!=null){
				try {
		...
		adapter = new SimpleCursorAdapter(this, R.layout.main_chat_list_item, null,
	 ...
	 private Runnable registerId = new Runnable(){
	    	@Override
	    	public void run(){
	    		//methode pour enregistrer email dans web service app engine 
	    		ServerUtilities.register(regid, regid);
	    		Log.i(TAG,"Registering @ server with :"+regid);
	    	}
	    };
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		getMenuInflater().inflate(R.menu.mainchat, menu);
		return true;
	}
	...
	case R.id.action_listm:
		Intent intent2 = new Intent(this, AfficahgeListMailActivity.class);
